...
namespace CCAF.DataAccessLayer
{
    public class DataAccessLayer
    {
        public static DataTable GetMyProfile(string usercode)
        {
            ...
            try
            {
                ...
                dt = CCAF.AppCode.Global.GetData_New("USP_ACXGETUSERPROFILE", CommandType.StoredProcedure, _plist, _vlist);
                dt.AcceptChanges();
            }
            catch (Exception ex)
            {
        ...
        public static DataTable GetOrderHistory(string usercode, string dataareaid, [Optional] string FromDate, [Optional] string ToDate)
        {
            ...
            try
            {
                ...
                dt = CCAF.AppCode.Global.GetData_New("USP_ACXGETORDERHISTORY", CommandType.StoredProcedure, _plist, _vlist);
                dt.AcceptChanges();
            }
            catch (Exception ex)
            {
        ...
        public static void SaveUserAuditDataToDB(AuditTB userAuditTBVM)
        {
            ...
            try
            {
                ...
                dt = CCAF.AppCode.Global.GetData_New("USP_ACXPOSTUSERAUDITDATATODB", CommandType.StoredProcedure, _plist, _vlist);
                dt.AcceptChanges();
            }
            catch (Exception ex)
            {
